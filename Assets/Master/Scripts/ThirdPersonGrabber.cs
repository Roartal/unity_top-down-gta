...
public class ThirdPersonGrabber : MonoBehaviour 
{
	...
	private ThirdPersonCharacterMotor playerMove;
	...
	void Update()
	{
		...
		if (Input.GetButtonDown ("Interact") && heldObj && Time.time > timeOfPickup + 0.1f)
		{
